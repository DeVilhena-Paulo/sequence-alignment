...
public class TestAlignment {
    ...
    public static void main (String[] arg) throws IOException {
        ...
        // scoreBlosum50
        System.out.println ("\n-----------------------------------------");
        System.out.println (  "Testing Alignment.scoreBlosum50 method...");

        //Test 1
        Alignment.maxinizeBlosum50Score ("OptSeq_Res8.txt");
        //Test 2
        Alignment.maxinizeBlosum50Score ("OptSeq_Res10.txt");
        //Test 3
        Alignment.maxinizeBlosum50Score ("OptSeq_Res13.txt");
        //Test 4
        Alignment.maxinizeBlosum50Score ("OptSeq_Res.txt");
